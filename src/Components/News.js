...
handleNextClick= async ()=>{
 ...
 fetchMoreData =  async () => {
  ...
  render() {
    return (
      <>
        <h2 className="text-center" style={{margin: '20px'}}>NewsMonk - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h2>
        ...
        {/* <div className="container d-flex justify-content-between">
          <button disabled={this.state.page<=1} type="button" className="btn btn-sm btn-dark" onClick={this.handlePrevClick}>&larr; Back</button>
